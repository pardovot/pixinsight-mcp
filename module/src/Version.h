...
// Bump MCPWATCHER_VERSION_* on each change; the dialog also shows the compile
// timestamp (__DATE__/__TIME__) so distinct builds are always distinguishable.
// ----------------------------------------------------------------------------
#ifndef __MCPWatcher_Version_h
#define __MCPWatcher_Version_h

#define MCPWATCHER_VERSION_MAJOR   1
#define MCPWATCHER_VERSION_MINOR   1
#define MCPWATCHER_VERSION_RELEASE 0

#define MCPWATCHER_VERSION_STR     "1.1.0"
